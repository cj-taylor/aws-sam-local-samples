...
```bash
stepfunction-stocktrader$ sam build
```
...
```bash
stepfunction-stocktrader$ sam logs -n StockCheckerFunction --stack-name stepfunction-stocktrader --tail
```
...
```bash
stepfunction-stocktrader$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name stepfunction-stocktrader
```
